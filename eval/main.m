...
Models = {'CSCAUNet_Kvasir_1e4_bs16_e120_s352'}; %{'UNet','UNet++','PraNet','SFA'};
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = '../data/TestDataset/';
Datasets = {'test'}; %{'CVC-ClinicDB', 'CVC-ColonDB','ETIS-LaribPolypDB', 'Kvasir','CVC-300'};
% ---- 3. Evaluation Results Save Path Setting ----
ResDir = './EvaluateResults/CSCAUNet_Kvasir_1e4_bs16_e120_s352/';
