...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
                        default=r"E:\HFUT\BME\BME_competition\Deep_Learning_Datasets\kvasir-seg/",
                        help='path to train dataset')

    parser.add_argument('--test_path', type=str,
                        default='./TestDataset/CVC-300/', help='path to testing Kvasir dataset')

    parser.add_argument('--train_save', type=str, default= "CSCAUNet_Kvasir_1e4_bs16_e120_s352")

    parser.add_argument('--model_name', type=str, default="CSCAUNet",
